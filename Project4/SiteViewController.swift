...
//  Project4
//
//  Created by Баир Надцалов on 04.09.2020.
...
class SiteViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://" + websites[indexPath])!
    ...
    // This method start when clicked a link (May be not only for this action)
